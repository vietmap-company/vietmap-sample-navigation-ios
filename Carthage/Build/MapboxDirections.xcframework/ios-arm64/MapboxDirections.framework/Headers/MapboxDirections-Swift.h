...
#ifndef MAPBOXDIRECTIONS_SWIFT_H
#define MAPBOXDIRECTIONS_SWIFT_H
...
- (nonnull instancetype)initWithIndications:(MBLaneIndication)indications OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL supportsSecureCoding;)
+ (BOOL)supportsSecureCoding SWIFT_WARN_UNUSED_RESULT;
+ (void)setSupportsSecureCoding:(BOOL)value;
...
///
- (nonnull instancetype)initWithIndications:(MBLaneIndication)indications isUsable:(BOOL)isUsable OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)coder;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
...
///
- (nonnull instancetype)initWithJSON:(NSDictionary<NSString *, id> * _Nonnull)json source:(MBWaypoint * _Nonnull)source destination:(MBWaypoint * _Nonnull)destination options:(MBRouteOptions * _Nonnull)options;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL supportsSecureCoding;)
+ (BOOL)supportsSecureCoding SWIFT_WARN_UNUSED_RESULT;
+ (void)setSupportsSecureCoding:(BOOL)value;
...
@property (nonatomic, readonly, copy) NSArray<MBVisualInstructionBanner *> * _Nullable instructionsDisplayedAlongStep;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
...
@property (nonatomic, readonly, copy) NSArray<id <MBComponentRepresentable>> * _Nonnull components;
...
@property (nonatomic, readonly, strong) MBVisualInstruction * _Nonnull primaryInstruction;
/// Less important details about the <code>RouteStep</code>.
@property (nonatomic, readonly, strong) MBVisualInstruction * _Nullable secondaryInstruction;
...
@property (nonatomic, readonly, strong) MBVisualInstruction * _Nullable tertiaryInstruction;
...
///
- (nonnull instancetype)initWithDistanceAlongStep:(CLLocationDistance)distanceAlongStep primaryInstruction:(MBVisualInstruction * _Nonnull)primaryInstruction secondaryInstruction:(MBVisualInstruction * _Nullable)secondaryInstruction tertiaryInstruction:(MBVisualInstruction * _Nullable)tertiaryInstruction drivingSide:(enum MBDrivingSide)drivingSide OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL supportsSecureCoding;)
+ (BOOL)supportsSecureCoding SWIFT_WARN_UNUSED_RESULT;
+ (void)setSupportsSecureCoding:(BOOL)value;
...
///
- (nonnull instancetype)initWithType:(enum MBVisualInstructionComponentType)type text:(NSString * _Nullable)text imageURL:(NSURL * _Nullable)imageURL abbreviation:(NSString * _Nullable)abbreviation abbreviationPriority:(NSInteger)abbreviationPriority OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
- (void)encodeWithCoder:(NSCoder * _Nonnull)coder;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
