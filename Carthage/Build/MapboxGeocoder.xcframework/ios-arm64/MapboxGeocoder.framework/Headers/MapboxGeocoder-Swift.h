...
#ifndef MAPBOXGEOCODER_SWIFT_H
#define MAPBOXGEOCODER_SWIFT_H
...
/// returns:
/// The data task used to perform the HTTP request. If, while waiting for the completion handler to execute, you no longer want the resulting placemarks, cancel this task.
- (NSURLSessionDataTask * _Nonnull)batchGeocodeWithOptions:(MBGeocodeOptions <MBBatchGeocodeOptions> * _Nonnull)options completionHandler:(void (^ _Nonnull)(NSArray<NSArray<MBGeocodedPlacemark *> *> * _Nullable, NSArray<NSString *> * _Nullable, NSError * _Nullable))completionHandler;
