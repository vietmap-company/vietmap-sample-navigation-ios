...
#ifndef MAPBOXSPEECH_SWIFT_H
#define MAPBOXSPEECH_SWIFT_H
...
#if defined(__OBJC__)
typedef SWIFT_ENUM_NAMED(NSUInteger, MBAudioFormat, "AudioFormat", closed) {
  MBAudioFormatMp3 = 0,
};


typedef SWIFT_ENUM_NAMED(NSUInteger, MBSpeechGender, "SpeechGender", closed) {
...
typedef SWIFT_ENUM_NAMED(NSUInteger, MBTextType, "TextType", closed) {
  MBTextTypeText = 0,
  MBTextTypeSsml = 1,
};
