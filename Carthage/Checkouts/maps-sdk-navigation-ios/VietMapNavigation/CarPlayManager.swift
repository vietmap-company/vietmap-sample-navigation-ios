...
extension CarPlayManager: CPApplicationDelegate {
    ...
    func panMapButton(for mapTemplate: CPMapTemplate, traitCollection: UITraitCollection) -> CPMapButton {
        ...
        let bundle = Bundle.VietMapNavigation
...
extension CarPlayManager: CPListTemplateDelegate {
    ...
    public func calculateRouteAndStart(from fromWaypoint: Waypoint? = nil, to toWaypoint: Waypoint, completionHandler: @escaping () -> Void) {
        ...
        let name = NSLocalizedString("CARPLAY_CURRENT_LOCATION", bundle: .VietMapNavigation, value: "Current Location", comment: "Name of the waypoint associated with the current location")
        ...
        Directions.shared.calculate(routeOptions) { [weak self, weak mapTemplate] (waypoints, routes, error) in
            ...
            if let error = error {
                let okTitle = NSLocalizedString("CARPLAY_OK", bundle: .VietMapNavigation, value: "OK", comment: "CPNavigationAlert OK button title")
            ...
            let goTitle = NSLocalizedString("CARPLAY_GO", bundle: .VietMapNavigation, value: "Go", comment: "Title for start button in CPTripPreviewTextConfiguration")
            let alternativeRoutesTitle = NSLocalizedString("CARPLAY_MORE_ROUTES", bundle: .VietMapNavigation, value: "More Routes", comment: "Title for alternative routes in CPTripPreviewTextConfiguration")
            let overviewTitle = NSLocalizedString("CARPLAY_OVERVIEW", bundle: .VietMapNavigation, value: "Overview", comment: "Title for overview button in CPTripPreviewTextConfiguration")
...
extension CarPlayManager: CPMapTemplateDelegate {
    ...
    func mapTemplate(forNavigating trip: CPTrip) -> CPMapTemplate {
        ...
        showFeedbackButton.image = UIImage(named: "carplay_feedback", in: .VietMapNavigation, compatibleWith: nil)
        ...
        let overviewButton = CPMapButton { [weak self] (button) in
            ...
            button.image = UIImage(named: imageName, in: .VietMapNavigation, compatibleWith: nil)
        }
        overviewButton.image = UIImage(named: "carplay_overview", in: .VietMapNavigation, compatibleWith: nil)
        ...
        let muteTitle = NSLocalizedString("CARPLAY_MUTE", bundle: .VietMapNavigation, value: "Mute", comment: "Title for mute button")
        let unmuteTitle = NSLocalizedString("CARPLAY_UNMUTE", bundle: .VietMapNavigation, value: "Unmute", comment: "Title for unmute button")
        ...
        exitButton.title = NSLocalizedString("CARPLAY_END", bundle: .VietMapNavigation, value: "End", comment: "Title for end navigation button")
