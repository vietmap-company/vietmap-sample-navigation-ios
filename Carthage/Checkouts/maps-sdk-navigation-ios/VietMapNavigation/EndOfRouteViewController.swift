...
class EndOfRouteViewController: UIViewController {
    ...
    // MARK: - Properties
    lazy var placeholder: String = NSLocalizedString("END_OF_ROUTE_TITLE", bundle: .VietMapNavigation, value: "How can we improve?", comment: "Comment Placeholder Text")
    lazy var endNavigation: String = NSLocalizedString("END_NAVIGATION", bundle: .VietMapNavigation, value: "End Navigation", comment: "End Navigation Button Text")
    ...
    private func styleForUnnamedDestination() {
        ...
        primary.text = NSLocalizedString("END_OF_ROUTE_ARRIVED", bundle: .VietMapNavigation, value:"You have arrived", comment:"Title used for arrival")
    }
