...
class ExitView: StylableView {
    static let leftExitImage = UIImage(named: "exit-left", in: .VietMapNavigation, compatibleWith: nil)!.withRenderingMode(.alwaysTemplate)
    static let rightExitImage = UIImage(named: "exit-right", in: .VietMapNavigation, compatibleWith: nil)!.withRenderingMode(.alwaysTemplate)
