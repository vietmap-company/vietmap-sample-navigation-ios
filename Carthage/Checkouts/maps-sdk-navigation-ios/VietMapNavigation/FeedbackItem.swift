...
extension UIImage {
    fileprivate class func feedbackImage(named: String) -> UIImage {
        return Bundle.VietMapNavigation.image(named: named)!
    }
}
...
fileprivate let closureTitle = NSLocalizedString("FEEDBACK_ROAD_CLOSURE", bundle: .VietMapNavigation, value: "Road\nClosed", comment: "Feedback type for Road Closed")
fileprivate let notAllowedTitle = NSLocalizedString("FEEDBACK_NOT_ALLOWED", bundle: .VietMapNavigation, value: "Not\nAllowed", comment: "Feedback type for a maneuver that is Not Allowed")
fileprivate let reportTrafficTitle = NSLocalizedString("FEEDBACK_REPORT_TRAFFIC", bundle: .VietMapNavigation, value: "Report\nTraffic", comment: "Feedback type for Report Traffic")
fileprivate let confusingInstructionTitle = NSLocalizedString("FEEDBACK_CONFUSING_INSTRUCTION", bundle: .VietMapNavigation, value: "Confusing\nInstruction", comment: "Feedback type for Confusing Instruction")
fileprivate let badRouteTitle = NSLocalizedString("FEEDBACK_BAD_ROUTE", bundle: .VietMapNavigation, value: "Bad \nRoute", comment: "Feedback type for Bad Route")
fileprivate let missingExitTitle = NSLocalizedString("FEEDBACK_MISSING_EXIT", bundle: .VietMapNavigation, value: "Missing\nExit", comment: "Feedback type for Missing Exit")
fileprivate let missingRoadTitle = NSLocalizedString("FEEDBACK_MISSING_ROAD", bundle: .VietMapNavigation, value: "Missing\nRoad", comment: "Feedback type for Missing Road")
fileprivate let generalIssueTitle = NSLocalizedString("FEEDBACK_GENERAL_ISSUE", bundle: .VietMapNavigation, value: "Other\nMap Issue", comment: "Feedback type for Other Map Issue Issue")
