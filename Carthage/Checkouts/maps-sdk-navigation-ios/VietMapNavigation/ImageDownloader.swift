...
class ImageDownloader: NSObject, ReentrantImageDownloader, URLSessionDataDelegate {
    ...
    override init() {
        ...
        self.downloadQueue.name = Bundle.VietMapNavigation.bundleIdentifier! + ".ImageDownloader"
        self.accessQueue = DispatchQueue(label: Bundle.VietMapNavigation.bundleIdentifier! + ".ImageDownloaderInternal", attributes: .concurrent)
    }
