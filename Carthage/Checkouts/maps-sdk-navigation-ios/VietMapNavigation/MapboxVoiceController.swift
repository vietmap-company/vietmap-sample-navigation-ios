...
open class MapboxVoiceController: RouteVoiceController, AVAudioPlayerDelegate {
    ...
    let localizedErrorMessage = NSLocalizedString("FAILED_INSTRUCTION", bundle: .VietMapNavigation, value: "Unable to read instruction aloud.", comment: "Error message when the SDK is unable to read a spoken instruction.")
