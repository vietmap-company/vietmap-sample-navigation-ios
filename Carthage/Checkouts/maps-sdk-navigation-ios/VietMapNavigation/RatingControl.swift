...
class RatingControl: UIStackView {
    ...
    private let starTemplate = UIImage(named: "star", in: .VietMapNavigation, compatibleWith: nil)
    ...
    private func addStars() {
        for index in 0..<starCount {
            ...
            let localizedString = NSLocalizedString("RATING_ACCESSIBILITY_SET", bundle: .VietMapNavigation, value: "Set %ld-star rating", comment: "Format for accessibility label of button for setting a rating; 1 = number of stars")
    ...
    private func setAccessibility(for button: UIButton, at index: Int) {
        ...
        let value: String
        if rating == 0 {
            value = NSLocalizedString("NO_RATING", bundle: .VietMapNavigation, value: "No rating set.", comment: "Accessibility value of label indicating the absence of a rating")
        } else {
            value = String.localizedStringWithFormat(NSLocalizedString("RATING_STARS_FORMAT", bundle: .VietMapNavigation, value: "%ld star(s) set.", comment: "Format for accessibility value of label indicating the existing rating; 1 = number of stars"), rating)
        }
    ...
    private func setAccessibilityHint(for button: UIButton, at index: Int) {
        ...
        button.accessibilityHint = NSLocalizedString("RATING_ACCESSIBILITY_RESET", bundle: .VietMapNavigation, value: "Tap to reset the rating to zero.", comment: "Rating Reset To Zero Accessability Hint")
    }
