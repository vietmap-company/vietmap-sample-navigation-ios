...
open class RouteVoiceController: NSObject, AVSpeechSynthesizerDelegate {
    ...
    let audioQueue = DispatchQueue(label: Bundle.VietMapNavigation.bundleIdentifier! + ".audio")
     ...
     */
    @objc public var rerouteSoundPlayer: AVAudioPlayer = try! AVAudioPlayer(data: NSDataAsset(name: "reroute-sound", bundle: .VietMapNavigation)!.data, fileTypeHint: AVFileType.mp3.rawValue)
