...
public class ResumeButton: UIControl {
    ...
    let imageView = UIImageView(image: UIImage(named: "recenter", in: .VietMapNavigation, compatibleWith: nil)!.withRenderingMode(.alwaysTemplate))
    ...
    func commonInit() {
        titleLabel.text = NSLocalizedString("RESUME", bundle: .VietMapNavigation, value: "Resume", comment: "Button title for resume tracking")
